...
struct FGBASourceViewIncludesListItem : public FGBAHeaderViewListItem
{
	explicit FGBASourceViewIncludesListItem(const TSharedPtr<FGBAAttributeSetWizardViewModel>& InViewModel);
