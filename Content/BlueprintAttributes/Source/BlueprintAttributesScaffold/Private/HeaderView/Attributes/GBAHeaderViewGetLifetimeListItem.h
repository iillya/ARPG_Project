...
struct FGBAHeaderViewGetLifetimeListItem : public FGBAHeaderViewListItem
{
	explicit FGBAHeaderViewGetLifetimeListItem(const TSharedPtr<FGBAAttributeSetWizardViewModel>& InViewModel);
